...
//used for controlling sound
    ...
    {
        private WeakReference<ListenService> mtarget;

        IncomingHandler(ListenService target)
        {
        ...
        {
            final ListenService target = mtarget.get();
...
//end of lowering
    ...
    protected CountDownTimer mNoSpeechCountDown = new CountDownTimer(5000, 5000)
    {
        ...
        public void onFinish()
        {
            ...
            {
                Log.d("Exceotion sanj1", e.getMessage());
            }
        }
    };
...
//        PowerManager.WakeLock wakeLock = mgr.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "My WakeLock");
...
//                buildForegroundNotification("Phone Finder"));
        ...
        {
            Log.d("Exceotion sanj", e.getMessage());
        }
...
//some details about the notification such as name and icon shown
        b.setContentTitle(getString(R.string.working))
                ...
                .setSmallIcon(R.drawable.gpstracking)
...
//assign a sound to the sound pool
            ...
            sound = sp.load(ListenService.this, R.raw.sound1, 1);
